...
def test_compute_triangle_area_known_triangles():
    ...
    assert dagmc_lib._compute_triangle_area((0, 0, 0), (1, 0, 0), (0, 1, 0)) == pytest.approx(0.5)

    # 3-4-5 right triangle -> area 6
    assert dagmc_lib._compute_triangle_area((0, 0, 0), (3, 0, 0), (0, 4, 0)) == pytest.approx(6.0)
    ...
    assert dagmc_lib._compute_triangle_area((1, 0, 0), (0, 1, 0), (0, 0, 1)) == pytest.approx(
        3**0.5 / 2
    )
...
def test_compute_triangle_area_degenerate():
    ...
    assert dagmc_lib._compute_triangle_area((0, 0, 0), (1, 1, 1), (2, 2, 2)) == pytest.approx(0.0)
