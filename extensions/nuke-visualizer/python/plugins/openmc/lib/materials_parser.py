...
class Nuclide:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {"name": self.name, "fraction": self.fraction, "fractionType": self.fraction_type}
...
class Material:
    ...
    temperature: float | None = None  # in K
...
class OpenMCMaterialsParser:
    ...
    def _parse_nuclide(self, elem: ET.Element) -> Nuclide | None:
    ...
    def _parse_thermal_scattering(self, elem: ET.Element) -> ThermalScattering | None:
    ...
    def get_material_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "materialsWithThermalScattering": sum(
                1 for m in self.materials_list if m.thermal_scattering
            ),
...
def get_material_cell_linkage(materials_path: str, geometry_path: str) -> dict[str, Any]:
    ...
    try:
        ...
        result = {
            "linkage": {str(mat_id): cells for mat_id, cells in material_cells.items()},
