                    ...
                    with vuetify.VRow(dense=True, align="center"):
                        for btn, action in [
                            ...
                            (
                                "<",
                                lambda: setattr(
                                    state, "current_timestep", max(0, state.current_timestep - 1)
                                ),
                            ),
                            (
                                ">",
                                lambda: setattr(
                                    state,
                                    "current_timestep",
                                    min(len(state.timestep_values) - 1, state.current_timestep + 1),
                                ),
                            ),
                            (
                                ">>|",
                                lambda: setattr(
                                    state, "current_timestep", len(state.timestep_values) - 1
                                ),
                            ),
                        ]:
...
@arg("--port", type=int, default=None, help="Port to run server on")
