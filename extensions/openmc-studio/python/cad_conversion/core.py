...
def is_axis_aligned(axis: List[float], tol: float = 0.05) -> Optional[str]:
...
def ransac_fit(points: List[List[float]],
               fit_fn,
               evaluate_fn,
               sample_size: int,
               max_iterations: int = 100,
               inlier_threshold: float = 0.01) -> Tuple[Optional[Any], List[int]]:
