...
class TestComputeSweepValues:
    def test_linear_range(self, ro):
        ...
        sweep = {'rangeType': 'linear', 'startValue': 0.0,
                 'endValue': 10.0, 'numPoints': 5}
    ...
    def test_linear_range_descending(self, ro):
        ...
        sweep = {'rangeType': 'linear', 'startValue': 5.0,
                 'endValue': 1.0, 'numPoints': 3}
    ...
    def test_log_range(self, ro):
        ...
        sweep = {'rangeType': 'logarithmic', 'startValue': 1.0,
                 'endValue': 100.0, 'numPoints': 3}
    ...
    def test_log_range_spans_decades(self, ro):
        ...
        sweep = {'rangeType': 'log', 'startValue': 1e-3,
                 'endValue': 1e3, 'numPoints': 5}
    ...
    def test_single_point_returns_start(self, ro):
        ...
        for n in (0, 1):
            sweep = {'rangeType': 'linear', 'startValue': 3.0,
                     'endValue': 9.0, 'numPoints': n}
...
class TestGenerateParameterCombinations:
    ...
    def test_single_sweep(self, ro):
        ...
        sweeps = [{'variable': 'density', 'rangeType': 'linear',
                   'startValue': 1.0, 'endValue': 3.0, 'numPoints': 3}]
    ...
    def test_cartesian_product_of_two_sweeps(self, ro):
        ...
        sweeps = [
            {'variable': 'a', 'rangeType': 'linear',
             'startValue': 0.0, 'endValue': 1.0, 'numPoints': 2},
            {'variable': 'b', 'rangeType': 'linear',
             'startValue': 10.0, 'endValue': 30.0, 'numPoints': 3},
        ]
        combos = ro.generate_parameter_combinations(sweeps)
        assert len(combos) == 6
